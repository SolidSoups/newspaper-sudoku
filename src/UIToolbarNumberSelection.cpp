...
namespace ge {
void UIToolbarNumberSelection::onInit() {
...
void UIToolbarNumberSelection::update(const float &deltaTime) {
...
void UIToolbarNumberSelection::render() { drawAnimation(); }

void UIToolbarNumberSelection::onClean() {}
void UIToolbarNumberSelection::onDestroy() {}
...
void UIToolbarNumberSelection::drawAnimation() {
