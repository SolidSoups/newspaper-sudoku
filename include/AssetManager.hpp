...
public:
  ...
  static ge::Texture *createCachedGETexture(const char *filepath,
                                            const ge::TextureProperties &props);
  // Retrieves a cached ge::Texture with the filePath as an index
  static ge::Texture *retrieveGETextureCache(const char *filePath);

  // caches ge::TextureSheet with the filePath as an index
  static ge::TextureSheet *
  createCachedGETextureSheet(const char *filepath,
                             const ge::TextureSplitProperties &props);
  // Retrieves a cached ge::TextureSheet with the filePath as an index
  static ge::TextureSheet *retrieveGETextureSheetCache(const char *filePath);
