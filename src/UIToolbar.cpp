...
void
UIToolbar::update(const float &deltaTime)
{
}
void
UIToolbar::render()
{
    ...
    SDL_FRect toolbarDst = {
        transform.position.x, transform.position.y, 64, 640
    };
    ...
    for (int i = 1; i <= 9; i++)
    {
        ...
        ge::GameRenderer::drawTexture(
            miniNumbersTextureSheet->textures[texID], numberDst);
        numberDst.y += 16 * 4;
    }
}
